...
from elaspic_rest_api.jobsubmitter.elaspic2 import COI, MutationInfo, extract_protein_info
...
def test_extract_protein_info(data_dir: Path, coi: COI):
    ...
    mutation_info = MutationInfo(
        structure_file=structure_file.as_posix(), chain_id="B", mutation="E1A", coi=coi
    )
